                ...
                <div class="col-12 col-md-4 col-lg-4 col-xl-4 doctor-sidebar">
                    <div class="doctor-list doctor-view">
                        <div class="doctor-inner">
                            <img class="img-fluid" alt="" src="/assets/img/users/<?= $doctors['image'] ?>">
                            <div class="doctor-details">
                                <div class="doctor-info">
                                    <h4 class="doctor-name">Dr. <?= $doctors['firstName'] . ' ' . $doctors['lastName'] . ' ' . $doctors['suffix'] ?></h4>
                                    <p>
                                        <span class="depart">
                                            <?php $specialties = explode(',', $doctors['specialty']);
                                            $i = 0;
                                ...
                                <div class="book-appointment">
                                    <a href="/login">Login To Book Appointment</a>
                                </div>
                            </div>
                        </div>
                    </div>
